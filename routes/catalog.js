...
router.post('/book/create',upload.single('ImageUrl'), book_controller.book_create_post);
...
router.post('/book/:id/update',upload.single('ImageUrl'), book_controller.book_update_post);
